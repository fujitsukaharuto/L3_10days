...
void RandomCSPipe::CreatePSO(ID3D12Device* device) {
    HRESULT hr;


    vs = dxcommon_->GetDXCompil()->CompileShader(kDirectoryPath_ + L"CS/Random.CS.hlsl", L"cs_6_0");
    assert(vs != nullptr);
