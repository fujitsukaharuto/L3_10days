...
void RetroTVCSPipe::CreatePSO(ID3D12Device* device) {
    HRESULT hr;


    vs = dxcommon_->GetDXCompil()->CompileShader(kDirectoryPath_ + L"CS/RetroTV.CS.hlsl", L"cs_6_0");
    assert(vs != nullptr);
