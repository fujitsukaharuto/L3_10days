...
BoxFilterCSPipe::~BoxFilterCSPipe() {
}
...
void BoxFilterCSPipe::CreatePSO(ID3D12Device* device) {
    HRESULT hr;


    vs = dxcommon_->GetDXCompil()->CompileShader(kDirectoryPath_ + L"CS/BoxFilter.CS.hlsl", L"cs_6_0");
    assert(vs != nullptr);
