...
/// 人間のコライダー用のオブジェクト
/// </summary>
class ClimberFrontTopCollider: public OriginGameObject {
public:
	ClimberFrontTopCollider(Climber* climber, CollisionManager* cMana);
	~ClimberFrontTopCollider()override = default;
